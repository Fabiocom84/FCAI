...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Rimosse le inizializzazioni Event Listeners per l'apertura dei Modali ---
    // Questi listener sono ora gestiti direttamente all'interno delle rispettive classi dei modali.
    // (e.g., NewOrderModal, InsertDataModal, ChatModal)
    ...
    // Questo listener è mantenuto qui nel main.js per coerenza con la tua struttura attuale
    // dato che 'updateAIDbBtn' potrebbe essere un elemento principale e non solo legato al modale logs.
